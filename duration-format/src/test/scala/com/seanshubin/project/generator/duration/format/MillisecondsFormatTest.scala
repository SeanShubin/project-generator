package com.seanshubin.project.generator.duration.format

import com.seanshubin.project.generator.duration.format.DurationFormat.{MillisecondsFormat, MillisecondsFormatPadded}
